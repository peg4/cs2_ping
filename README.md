# 🌍 Steam server Ping & Traceroute Tool

> 🇷🇺 Русская версия | 🇬🇧 [English version](README_en.md)

Этот скрипт позволяет быстро и наглядно оценить задержку (пинг) и трассировку до различных **серверов Steam** в **европейских городах**.
